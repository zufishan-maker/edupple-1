...
{
    public class PermissionConfiguration : BaseConfiguration<Permission, int>
    {
        public PermissionConfiguration(ModelBuilder modelBuilder) : base(modelBuilder)
        {
        ...
        public override void Configure()
        {
            ...
            _builder.Property(p => p.UpdatedBy)
                .HasColumnType("text");
            _builder.ToTable("tbl_permission", "dbo");
        }
    }
}
